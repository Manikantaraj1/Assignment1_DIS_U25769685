...
*/
        ...
        {
            /*By solving this problem I am able to learn how to use for loop in c#. I have some basic knowledge in C## by solving this problem I learned the try and catch statement in c#
            */
            try
            {
...
*/
        ...
        {
            /*Generally if we use contains or hashmap it is easy to solve the problem, but here I use nested for loop, though it affects the performance I am able to solve this without using hashmap and constains
			*/
            int i = 0;
            try
            {
        ...
        */
        ...
        {
            /*Here I again used nested for loop to find out Num Identicalpairs where I looped hrough the array and found out the identical pairs
			*/
            try
            {
                int total = 0;
                ...
                {
                    for (int j = i + 1; j < arr.Length; j++)    //Looping thorugh the array element to check the next element in array
                    {
                        if (arr[i] == arr[j])
        ...
        */
        ...
        {
            /*by doing this I got hands experience in Dynamic programming and learnt what is pivot indexing
			*/
            try
            {
                int sum = 0;
...
/// <returns>return the merged string </returns> */
        ...
        {
            /*Here again I used dynamic programming approach where I calculated the sum and used for loop to concatenate the both strings. Here I learnt about indexing in c#
			*/
            try
            {
                string mergedString = "";
...
*/
        ...
        {
            /*In this I learnt how to use string builder and trim the excess space at end and concatination of the string using string builder
			*/
            try
            {
